...
## Terms-acceptance failures (exit code `3`)

MemScope requires a one-time acceptance of its terms. On a TTY it
...
Then email it to <dumitrescu.adrian121@gmail.com> with a short
description of what you ran and what you expected. The ZIP contains
version, environment, and parser diagnostics with filesystem paths
sanitized — it is safe to attach.
